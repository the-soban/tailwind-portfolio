            ...
            <section className="min-h-screen">
                <nav className="navbar py-10 mb-12 flex justify-between">
                    ...
                    <ul className="flex items-center gap-6">
                        ...
                        <li>
                            <a
                                className="font-Poppins text-white bg-gradient-to-r from-cyan-500 to-teal-500 px-4 py-2 rounded-xl"
                                target="_blank"
                                href="/resume.pdf"
                ...
                <div className="text-center p-10">
                    <h2 className="text-4xl font-Poppins font-extrabold py-2 text-teal-600 md:text-5xl">
                        Soban Shafiq
                    </h2>

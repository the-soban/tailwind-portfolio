    ...
    <main className='bg-white px-12 md:px-20 lg:px-40'>
      ...
      <section className='mt-12'>
        <div>
          ...
          <p className='text-md font-Poppins py-2 leading-8 text-gray-700'>My journey into web development started as a hobby, something I did in my spare time. I used to design website UIs in 
      ...
      <section className="py-10">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 lg:w-96">
              <Image
                ...
                alt='project'
              />
              <a className='font-Poppins text-white bg-gradient-to-r from-cyan-500 to-teal-500 px-4 py-2 my-4 rounded-xl' href='#'>Github Repo</a>
              <a className='font-Poppins text-white bg-gradient-to-r from-teal-500 to-cyan-500 px-4 py-2 mx-4 rounded-xl' href='#'>Live Demo</a>
            </div>

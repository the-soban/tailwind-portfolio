  ...
  return (
    <main className='bg-white px-12 md:px-20 lg:px-40'>
      <section className='min-h-screen'>
        <nav className='navbar py-10 mb-12 flex justify-between'>
          ...
          <ul className='flex items-center gap-6'>
            <li className='cursor-pointer text-2xl'><HiMail/></li>
      ...
      <section className='mt-12'>
        <div>
          <h3 className='text-3xl font-Poppins font-bold py-1'>My Skillset</h3>
          <p className='text-md font-Poppins py-2 leading-8 text-gray-700 dark:text-white'>My journey into web development started as a hobby, something I did in my spare time. I used to design website UIs in 
          ...
          <p className='text-md font-Poppins py-2 leading-8 text-gray-800'>I also have a background in working as a freelance <span className='text-teal-600'>Graphic Designer</span>, which has 
      ...
      <section className="py-10">
          <div>
            <h3 className="text-3xl font-Poppins font-bold py-1 ">Recent Work</h3>
            <p className="text-md font-Poppins py-2 leading-8 text-gray-800">Here's some <span className='text-teal-600'>websites and UI Designs</span> I have worked on recently: </p>
          </div>
          <div className="flex flex-col gap-10 py-10 md:flex-row md:flex-wrap lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1">
              <Image
                ...
                alt='project'
              />
              <a className='font-Poppins text-white bg-gradient-to-r from-cyan-500 to-teal-500 px-4 py-2 my-4 rounded-xl md:text-xs lg:text-base' href='#'>Github Repo</a>
              <a className='font-Poppins text-white bg-gradient-to-r from-teal-500 to-cyan-500 px-4 py-2 mx-4 rounded-xl md:text-xs lg:text-base' href='#'>Live Demo</a>
            </div>
            <div className="basis-1/3 flex-1">
              <Image
                className="rounded-xl object-cover mb-6 w-full hover:w-[98%] transition-all duration-400 cursor-pointer"
        ...
        <section className='py-10'>
          <div>
            <h3 className="text-3xl font-Poppins font-bold py-1 ">Contact Me</h3>
            <p className="text-md font-Poppins mb-4 py-2 leading-8 text-gray-800">Enough about me and my work. Now, let's talk about <span className='text-teal-600'>your project</span>.</p>
            <a className='font-Poppins text-white bg-gradient-to-r from-cyan-500 to-teal-500 px-4 py-2 my-4 rounded-xl' href='#'>Send me an Email</a>
          </div>
        </section>

        <section className='flex justify-center align-middle'>
          <span className='text-xs font-Poppins text-gray-600 text-center mt-12 mb-4 mx-auto inline-block'>Copyright © Soban Shafiq - 2023</span>
        </section>
    </main>
  );
}
